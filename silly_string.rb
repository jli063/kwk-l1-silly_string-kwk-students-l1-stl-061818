...
favorite_word_in_all_caps = you # Put a . after your_favorite word and use a String method.
...
puts "There are now #{new_letter_count} in #{big_word}"+"wow"+"mom"
...
puts "#{sentence}".gsub('O','A').gsub('o','a') 
